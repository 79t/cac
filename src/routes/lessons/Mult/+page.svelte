...
<svelte:head>
	<title>How to Multiply and Divide</title>
</svelte:head>

<Stepper class="m-20">
    <Step><svelte:fragment slot="header">Multiplication</svelte:fragment><br>
        <b>Restate the problem as an addition problem.</b></Step>
